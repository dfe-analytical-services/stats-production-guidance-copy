...
From late 2020, the Central Statistics Support Unit has been leading on developing guidance and support for producers to embed best practice in their writing.

Teams can now continually improve their publications, assessing against best practice using our [content checklist](#guidance-and-support)

We are running publication scrums where teams can put forward their publication(s) for review by a group of volunteer analysts, providing feedback as ‘unfamiliar new readers’ to discuss ideas for further improvements. If any of this is of interest to you or your team, please contact Heather Brown.
...
The checklist, although a good tool, does not enable the user to think this through as clearly from a new readers perspective, and therefore publication leads should fully consider this, and potential mitigations. 

Some examples/tips on writing are included below and should be considered by publication leads.
...
CSSU are running publication scrums, which enable publications to be looked at with fresh eyes through a workshop with volunteers and the publication team. The content checklist, which breaks down the components of producing Best Practice content into smaller chunks with prompt questions is used [(Download checklist)](resources/Content_Design_Logbook.xlsx){target="_blank" rel="noopener noreferrer"}, along with workshop slides. 
...
Once definitions have you added, you can add them as URL links into your commentary. E.g. to see the definition for 'Otherwise vulnerable', you'd make that phrase a hyperlink, and use https://explore-education-statistics.service.gov.uk/glossary#otherwise-vulnerable as the link.
...
If you're interested in having your publication peer reviewed, please see the [publication scrums](#publication-scrums) section above.
...
Did you know that we collect data on every publication live on EES in our [analytics app](https://rsconnect/rsc/ees-analytics){target="_blank" rel="noopener noreferrer"}? This tells you a range of things like:
