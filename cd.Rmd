...
Below is a session by Robert Cuffe from the BBC talking to DfE statisticians about writing our publications in a way they can be used by journalists and the media. The session is a mix of a talk, interactive elements and a question and answer session to round off. For the interactive tasks, you follow along to help give you a sense of how journalists use our publications.
