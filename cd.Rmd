...
A content checklist, which breaks down the components of producing Best Practice content into smaller chunks with prompt questions has been developed and is used in our content design scrums. [(Download checklist)](resources/Content_Design_Logbook.xlsx){target="_blank" rel="noopener noreferrer"}
