...
More complex charts cannot currently be built in EES. You should only use complex charts where there is a clear user need, as simple charts are the easiest for users to understand. For more information on how to best-practice for building infographics outside of the EES chart builder, including guidance for colours to use in charts, please see our [infographics guidance](ees.html#Other_chart_types)
