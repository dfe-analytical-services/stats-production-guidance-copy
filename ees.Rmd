...
To create a map, add the cuts of data you want to display in the "data sets" tab of the chart builder.
...
You can add further subheadings underneath this
Try to limit the number of subheadings per accordion to 10 at the most. Too many subheadings will make it tricky for users to find what they are looking for. 
