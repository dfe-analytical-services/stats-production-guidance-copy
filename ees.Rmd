...
You'll need to give a 'subject name' to each data file you upload. The subject name should be user-friendly as this is what users will see within wherever this file is referenced within EES. The actual file name can include more technical / coverage information.
