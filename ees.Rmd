...
Please note that the admin side of EES is only supported in Google Chrome and Microsoft Edge. It will not work correctly in Internet Explorer.

The public side does support Internet Explorer, however we still recommend that people use Chrome or Edge instead.
</div>
