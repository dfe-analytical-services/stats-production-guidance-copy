...
2. The admin website  
Where production teams create their stats - https://admin.explore-education-statistics.service.gov.uk/
...
Analysts are able to test the service within the platforms test environment (again, please contact the [Statistics Development Team](mailto:explore.statistics@education.gov.uk) to request access):


Public test environment - https://test.explore-education-statistics.service.gov.uk

Admin test environment - https://admin.test.explore-education-statistics.service.gov.uk
...
<div class="alert alert-dismissible alert-info">
When creating footnotes, make sure to add any symbols that you've used as footnotes - such as "c" for suppressed cells, so that they appear alongside tables ([GSS recommended symbols](https://gss.civilservice.gov.uk/wp-content/uploads/2017/03/GSS-Website-Harmonised-Symbols-Supporting-Documentation.pdf){target="_blank"}).
</div>
...
1. The [Statistics Development Team](mailto:explore.statistics@education.gov.uk) can mock up a first draft in the platform for you to then review and edit. For this to happen you'll need to send us the following:
   ...
   - Underlying data files that have passed the [screening checks](ud.html#how_to_check_against_the_standards){target="_blank"}
...
2. [Contact us](mailto:explore.statistics@education.gov.uk) for permission to access the production environment, telling us about the release you plan to republish, then build your release following the checklist below:
   * Run your data and metadata through our [screening checks](ud.html#how_to_check_against_the_standards){target="_blank"}
   * [Upload your data](#uploading-data) to your release on EES
   * [Write footnotes](#uploading-data)
   * [Create content](cd.html){target="_blank"} (including tables and charts)
