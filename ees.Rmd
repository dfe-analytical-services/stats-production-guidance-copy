...
If you are bookmarking links, please be careful to bookmark the links here exactly as they are shown here. Often when signing in you will be redirected via other url's as a part of the authentication process, and bookmarking those may lead to errors.
</div>
...
<div class="alert alert-dismissible alert-danger">
The admin side of EES is only supported in Google Chrome and Microsoft Edge. It will not work correctly in Internet Explorer.
</div>

<div class="alert alert-dismissible alert-info">
The public side does support Internet Explorer, though we still recommend that people use Chrome or Edge instead.
</div>
...
Analysts are able to test the service within the EES test environment (again, please contact the [Statistics Development Team](mailto:explore.statistics@education.gov.uk) to request access):
