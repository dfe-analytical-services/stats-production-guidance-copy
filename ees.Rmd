...
For any charts made outside of EES you must be using [GDS colours](https://design-system.service.gov.uk/styles/colour/), the following hex codes represent the colours that are available for charts in EES, we strongly recommend you stick to these (if you can't for any reason, please get in touch with us so we can understand why):

| Colour name (GDS) | Hex code |
|-------------------|----------|
| Blue              | #1d70b8  |
