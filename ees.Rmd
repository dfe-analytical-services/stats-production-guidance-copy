...
Once the drafting has finished, a methodology should be set as 'appoved for publication'. After this has happened, it will then appear in the drop down menu to attach to a publication. The methodology will then be published to the public side of the platform with the next release.
