...
We have a type of role within EES admin called ‘Publication Owner’. This permissions level gives publication owners control over their publications. As well as being able to manage the publication details, the publication owner also has access to:
...
In future this will also include managing methodology pages and we hope to stretch it to include setting release permissions too.
