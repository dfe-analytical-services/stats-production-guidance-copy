...
Permissions for your first release in the production environmnet currently requires a two step process. If you have not used the platform before you will first recieve an email inviting you to access the platform - you must click this link before we can grant specific release permissions.
