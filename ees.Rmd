...
Once you’re happy with your release and methodology, you need to go to the sign off page and change their status in order to move them through the release pipeline.
...
Once the drafting has finished, [update your methodology status](#Sign_off) to mark it as ready for review. Your approver can then either set your methodology to go live immediately, or set it to be published alongside a particular release.
