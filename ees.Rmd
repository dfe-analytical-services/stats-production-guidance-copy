...
These roles are assigned at release level to users, with the exception of publication owners, which are assigned at a publication level to the users account
...
New releases can be [created by publication owners](#Create_new_release) or via requests to the [Explore Statistics Mailbox](mailto:explore.statistics@education.gov.uk).  
