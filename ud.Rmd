...
Where you have data for a legacy LA that does not have a 9-digit new code, leave those cells as blank instead. Aside from blanks, no two rows should have the same code.
</div>
...
- Aside from blanks, no two rows should have the same code.
