...
For some categorical filters, this can more complicated. You might have a great number of different filters that you would rather group together in a hierarchy to help the end user navigate through them in the table tool. You can do this by grouping a filter by a filter group. This essentially uses another filter column to provide a higher group level for the options in the user interface when creating tables. For example, you may want to group percentages into wider rate bands.
