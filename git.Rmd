...
<p class="text-muted">Guidance and tips for using the version control software Git</p>
...
When you create a git project, it will automatically create a "master" branch for you. This is where code that has been QA'd and you are happy with should sit.
...
- Having two separate branches means that if anything goes wrong in the "development" branch, everything can be reverted to the last QA'd version in "master", without having to lose too much work.
