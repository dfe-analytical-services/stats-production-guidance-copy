...
Implementing RAP for us will involve combining the use of SQL, R, and clear, consistent version control to increase efficiency and accuracy in our work. For more information on what these tools are, why we are using them, and resources to help upskill in those areas, see our [learning resources](l+d.html){target="_blank"} page.
...
<body><div class="mxgraph" style="max-width:100%;border:1px solid transparent;" data-mxgraph="{&quot;highlight&quot;:&quot;#0000ff&quot;,&quot;nav&quot;:true,&quot;resize&quot;:true,&quot;toolbar&quot;:&quot;zoom layers lightbox&quot;,&quot;edit&quot;:&quot;_blank&quot;,&quot;xml&quot;:&quot;&lt;mxfile host=\&quot;app.diagrams.net\&quot; modified=\&quot;2020-10-09T18:17:28.403Z\&quot; agent=\&quot;5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.75 Safari/537.36\&quot; etag=\&quot;Cq_OruoN0gj1kqrIQCnZ\&quot; version=\&quot;13.7.4\&quot; type=\&quot;google\&quot;&gt;&lt;diagram id=\&quot;_ltWYIdbVKAG_Xyvna0Y\&quot; name=\&quot;Page-1\&quot;&gt;&lt;/diagram&gt;&lt;/mxfile&gt;&quot;}"></div>
...
[![](images/RAP-Process-Overview.png)](https://rsconnect/rsc/stats-production-guidance/images/RAP-Process-Overview.png)
...
Below are checklists designed to make reviewing our processes against our RAP levels easier, giving a straightforward list of questions to check our work against. This will flag areas that require improvement, and we can then use the links or sidebar to go to the specific section with more detail and guidance on how to get there.


<div info box pointing to the publication tracker app?>
...
## Use appropriate tools <!------- Hexagon / Good ------>
...
## Sensible folder and file structure <!------- Hexagon / Good ------>
`r knitr::include_graphics("images/good.svg")`
...
Other questions to help you consider whether your folder structure is sensible are:
...
- Are there subfolders like 'code', 'documentation'', 'outputs' and 'final' to save the relevant working files in? 
...
As far as meeting the requirement to have all source data in the same database, databases other than SQL are acceptable, though we can't support them in the same way.

When we refer to 'source data', we take this to mean the data you use at the start of the process to create the underlying data files. Any cleaning at the end of a collection will happen before this. The principle is that this source data will remain stable and is the point you can go back to and re-run the processes from if necessary. If for any reason the source data needs to change, your processes will be set up in a way that you can easily re-run them to get updated outputs based on the amended source data with minimal effort.

## All source data stored in single database <!------- Hexagon / Good ------>
`r knitr::include_graphics("images/good.svg")`
...
We should all be using code to process our data, moving away from a reliance on Excel, SPSS, and manual processing. In order to carry out our jobs to the best of our ability it is imperative that we use the [appropriate tools](l+d.html#open-source) for the work that we do.

Using code is as simple as telling your computer what to do. Code is just a list of instructions in a language that your computer can understand. This brings numerous benefits, computers are far quicker, more accurate, and far more reliable than humans in many of the tasks that we do. Writing out these instructions saves us significant amounts of time, particularly when it can be reused in future years, or even next week when one specific number in the source file suddenly changes, and also provides us with editable documentation for our production processes, saving the need for writing down information in extra documents. 
...
The key thing to remember is that **we should be automating everything we can**, avoiding any manual steps. Even steps such as copy and pasting data are fraught with danger, and these risks should be minimised by using code to document and execute these processes instead. This means that once teams have developed their code, they can then execute the code and have their underlying data files ready from a single click of a button. Designing processes in this way will make them better documented and reduce human error, increasing efficiency and reliability. 

Ensure that any fixes to the process are written in code and not done with manual changes. This way you will keep an audit trail of what has happened, which brings numerous benefits and assurances.

## Using single code scripts

### Single production script(s) <!------- Hexagon / Great ------>
`r knitr::include_graphics("images/great.svg")`

**What does this mean?**

Great practice ensures that each file can be creatde using a single script. This script should take the source data right through to final output at the push of a button. Furthermore, this should includes any manipulation, aggregation, suppression etc.	Having a single script for this saves time when needing to rerun processes, and provides a clear documentation of how a file is produced.

**Why do it?**

**How to get started**

### Single production scripts(s) with integrated QA <!------- Hexagon / Best ------>
`r knitr::include_graphics("images/best.svg")`

**What does this mean?**

Best practice ensures that all quality assurance for a file is also included in this single script. Even better is to have all automated summaries generated from there too, so that all of that is immediately available if you ever need to make changes to a file.

**Why do it?**

**How to get started**

### Single publication production script <!------- Hexagon / Best ------>
`r knitr::include_graphics("images/best.svg")`

**What does this mean?**

Finally, the ultimate aim is to utilise a single script to run off everything for a publication, this carries all of the same benefits as having a single master script for a file, but at a wider publication level, effectively documenting the entire publication process in one place. This script should allow you to run individual outputs by themselves as well, so make sure that each data file can be run in isolation by running single lines of this script.
...
## Recyclable code for future use <!------- Hexagon / Great ------>
`r knitr::include_graphics("images/great.svg")`

**What does this mean?**

 We'd expect that any recyclable code would take less than 30 minutes of editing before being able to run again in a future iteration of the publication. When writing the code you should consider:
...
**Why do it?**
 ...
 One huge benefit that comes with using code in our processes, is that we can pick them up in future years and reuse with minimum effort, saving us huge amounts of resource. To be able to do this, we need to be consious of how we write our code, and write it in a way that makes it easy to use in future releases for the publication. 
...
### Processing is done with code <!------- Hexagon / Good ------>
`r knitr::include_graphics("images/good.svg")`
...
Below are some examples of common processes to help ease the transition to using code in processing data. More resources can be found on our [learning resources page](l+d.html).
...
### Peer review of code within team <!------- Hexagon / Great ------>
`r knitr::include_graphics("images/great.svg")`
...
- Has someone else in the team reviewed the code? Are they able to generate the same outputs?
...
### Peer review of code from outside the team <!------- Hexagon / Best ------>
`r knitr::include_graphics("images/best.svg")`
...
While peer reviewing code within the team is often practice, having external analysts peer review your code can bring a fresh perspective. If you're interested in this, please contact us, and we can help you to arrange someone external to your team to review your processes. For this to work smoothly, we recommend that your code is [open](#link to a section I should have somewhere).
...
### Basic automated QA <!------- Hexagon / Good ------>
`r knitr::include_graphics("images/good.svg")`
...
### Publication specific automated QA <!------- Hexagon / Great ------>
`r knitr::include_graphics("images/great.svg")`
...
### Automated summaries <!------- Hexagon / Great ------>
`r knitr::include_graphics("images/great.svg")`
...
### Subject specific automated summaries <!------- Hexagon / Best ------>
`r knitr::include_graphics("images/best.svg")`

**What does this mean?**

However, the best practice is for teams to write their own bespoke automated summaries: 
...
If you can't say yes to the above, then consider:

- Integrating extra publication-specific QA into the production process
 
- Consider outputs to write commentary/draw out interesting analysis
...
Ultimately your documentation should allow another analyst from a different area to pick up your process and use it. There should be a README notes file, that clearly details the steps in the process, any dependencies (such as places where access needs to be requested to) and how to carry out the process. Any specialist terms should also be defined if required (e.g. The NFTYPE lookup can be found in xxxxx. "NFTYPE" means school type).
...
Commented lines should begin with -- (SQL) or # (R), followed by one space and your comment. Remember that **comments should explain the why, not the what.** Use commented lines of - to break up your files into scan-able chunks based upon the structure and subheadings, like the R example below, you'll thank yourself later:
...
For R in particular, there's a number of ways you can section up and even fold chunks of your code to make your life easier when working on it - [RStudio guidance on folding and sectioning code](https://support.rstudio.com/hc/en-us/articles/200484568-Code-Folding-and-Sections){target="_blank"}.
...
### Version controlled final versions of code <!------- Hexagon / Great ------>
`r knitr::include_graphics("images/great.svg")`
...
Questions to ask when checking if you meet the criteria:
...
For now please refer to the resources above, or the other links on the [learning resources](l+d.html#git){target="_blank"} page in order to learn how to use git in practice.



### Collab and develop code using git <!------- Hexagon / Best ------>
`r knitr::include_graphics("images/best.svg")`
