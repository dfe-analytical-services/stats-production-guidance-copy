...
Below are checklists designed to make reviewing our processes based on the graphic above easier, giving a straightforward list of questions to check our work against. This will flag areas that require improvement, and we can then use the links or sidebar to go to the specific section with more detail and guidance on how to get there.
...
- Is all [data processing done with code script(s)](#using-code-to-process-data)?

- Is there a [sensible folder/file structure](#folder-structures)?

- Are [appropriate tools](#using-code-to-process-data) being used to create data files?

- Is all [source data stored in a single database](#getting-your-data-together-in-sql)?

- Is there [suitable documentation](#documentation)?

- Do all data files meet the [data standards](ud.html#how_to_check_against_the_standards)?

- Are there [basic automated QA checks](#basic-automated-qa)?
...
- Is the code [recyclable for future use](#writing-recyclable-code)?

- Is each data file produced with a [single code script](#using-code-to-process-data)?

- Are final code script(s) saved in a [version controlled repository](#how-to-setup-an-azure-devops-area)?

- Are [automated summaries](#automating-summary-statistics) generated for insight?

- Has all code been [peer reviewed](#peer-reviewing-code) within the team?

- Are there [publication specific automated QA](#publication-specific-qa) checks?
...
- Is code [collaboratively developed using git](#using-git-in-practice)?

- Are publication specific [automated summaries](#automating-summary-statistics) generated for insight?

- Are data files produced via [single code script(s)](#using-code-to-process-data) with integrated QA?

- Can the publication be reproduced using a [single code script](#using-code-to-process-data)?

- Are final code script(s) [cleanly formatted](#using-code-to-process-data)?

- Has all code been [peer reviewed](#peer-reviewing-code) from outside the team?
...
Something here on peer reviewing within the team, good practices and things to do.
