...
More details on setting up analytics for your dashboard will follow shortly, for help and advice on this in the meantime please take a look at this [example file](https://github.com/dfe-analytical-services/exclusion-statistics/blob/master/www/google-analytics.js) adding Google Analytics to a shiny dashboard, or contact statistics.development@education.gov.uk.
...
We recommend using Github Actions to deploy the latest code whenever a push to your master branch occurs - this ensure the published version of your app stays up to date. 
