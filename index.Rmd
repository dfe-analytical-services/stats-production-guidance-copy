...
We also have a number of other applications for statistics production teams to use, they can be accessed at the links below when using a DfE device:


- DfE QA app (including the 'data screener') - https://rsconnect/rsc/dfe-published-data-qa/

- Explore Education Statistics Analytics - https://rsconnect/rsc/ees-analytics/

- Publication self-assessment tool - https://rsconnect/rsc/publication-self-assessment/
