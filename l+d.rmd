...
As statistics producers we require a variety of tools to be able to process our data, and as you probably know, there are a wealth of tools out there to process and analyse data.
...
Getting a friend or colleague to show us around the environment such as MSSMS or RStudio, and how to access real data is a critical step. It's important not to overlook the practical element of how you use these tools on your own machine with your own data, as you will need to be using these tools in your day to day processes to properly start learning. It's like driving a car, you can have as many lessons as you want, but the true experience comes from being left alone in full control of the machine!
