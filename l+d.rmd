...
Teams are welcome to use whatever tools they want, as long as the proccesses involved meet the [principles of RAP](/rsc/stats-production-guidance/rap.html#core_principles){target="_blank"}.
</div>
...
For more information on how to use these tools in your production processes, please see the [production processes](/rsc/stats-production-guidance/rap.html){target="_blank"} page.
