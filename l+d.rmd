...
More tips for moving from using Excel to using R can be found in the [excel-to-R github wiki](https://github.com/dfe-analytical-services/excel-to-R/wiki/Excel-to-R---how-do-I...).  
