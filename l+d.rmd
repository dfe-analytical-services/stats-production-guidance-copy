...
For best practice when coding, see the [DfE Good Code Practice guide](https://dfe-analytical-services.github.io/good-code-practice/index.html){target="_blank" rel="noopener noreferrer"}.
...
- [DataCamp](https://learn.datacamp.com/){target="_blank" rel="noopener noreferrer"} has a multitude of courses across R, SQL, Git and other languages. Many of the courses are free to start, and if you email Learning.Academy@ons.gov.uk, they can guide you through the process of getting access to one of their premium subscriptions for a few weeks, which allows you to access the rest of the courses.
...
### Passing variables as functions arguments
...
Git is a version control software that tracks changes to files within a folder that you tell git to track. These folders are generally known as repositories, and can be held and managed securely on team areas within the [DfE Azure DevOps](https://dfe-gov-uk.visualstudio.com/){target="_blank" rel="noopener noreferrer"} subscription. More specific guidance on how to setup and use your own DevOps area will follow shortly on the [production processes](rap.html#how_to_setup_an_azure_devops_area){target="_blank" rel="noopener noreferrer"} page.
